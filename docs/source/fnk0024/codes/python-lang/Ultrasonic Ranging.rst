...
1.	Use cd command to enter 21.1.1_UltrasonicRanging directory of Python code.

.. code-block:: console

    $ cd ~/Freenove_Kit/Code/Python_GPIOZero_Code/21.1.1_UltrasonicRanging
...
.. literalinclude:: ../../../freenove_Kit/Code/Python_GPIOZero_Code/21.1.1_UltrasonicRanging/UltrasonicRanging.py
    :linenos: 
    :language: python
...
.. literalinclude:: ../../../freenove_Kit/Code/Python_GPIOZero_Code/21.1.1_UltrasonicRanging/UltrasonicRanging2.py
    :linenos: 
    :language: python
